 ...
 * shuffleboard.json that is in the same directory as this command
 */
 ...
 */
    ...
    protected void initialize() {
        ...
        m_pidController = Robot.sub_climber.m_sparkMax.getPIDController();
        m_encoder = Robot.sub_climber.m_sparkMax.getEncoder();
